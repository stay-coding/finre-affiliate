...
@section('content')
    ...
    <main class="mt-10">
        <section class="grid 2xl:grid-cols-10 lg:grid-cols-6 grid-cols-1 gap-3">
            ...
            <div class="2xl:col-span-2 xl:col-span-2 lg:col-span-3 col-span-1">
                <x-indicator-card
                    :jumlah="'Rp ' . number_format($data['total_comission']->total_balance ?? 0,0,',','.')"
                    judul="Komisi"
        ...
        <section class="mt-10 bg-white p-5 rounded-md dark:bg-slate-900">
            <form action="afiliator" autocomplete="off" method="GET" class="mb-5 max-w-xl space-y-4">
                <x-input-field
                    id="from"
                    label="Dari"
                    type="date"
